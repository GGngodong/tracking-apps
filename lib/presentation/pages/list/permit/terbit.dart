...
class TerbitPage extends StatefulWidget {
  const TerbitPage({super.key});

  @override
  State<TerbitPage> createState() => _TerbitPageState();
}

class _TerbitPageState extends State<TerbitPage> {
  String? _authToken;
  ...
  Widget _buildBody(PermitLetterReleaseState state) {
