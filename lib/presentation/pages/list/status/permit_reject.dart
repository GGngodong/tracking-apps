...
class PermitReject extends StatefulWidget {
  const PermitReject({super.key});

  @override
  State<PermitReject> createState() => _PermitRejectState();
}

class _PermitRejectState extends State<PermitReject> {
  String? _authToken;
  ...
  Widget build(BuildContext context) {
    return BlocListener<PermitLetterRejectBloc, PermitLetterRejectState>(
      ...
      child: BlocBuilder<PermitLetterRejectBloc, PermitLetterRejectState>(
  ...
  Widget _buildBody(PermitLetterRejectState state) {
