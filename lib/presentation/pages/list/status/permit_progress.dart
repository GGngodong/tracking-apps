...
class PermitProgress extends StatefulWidget {
  const PermitProgress({super.key});

  @override
  State<PermitProgress> createState() => _PermitProgressState();
}

class _PermitProgressState extends State<PermitProgress> {
  String? _authToken;
  ...
  void _fetchPermitLetters() {
    if (_authToken != null) {
      context.read<PermitLetterProgressBloc>().add(GetListPermitLetter());
    }
  }

  @override
  Widget build(BuildContext context) {
    return BlocListener<PermitLetterProgressBloc, PermitLetterProgressState>(
      ...
      child: BlocBuilder<PermitLetterProgressBloc, PermitLetterProgressState>(
        builder: (context, state) {
          return RefreshIndicator(
            color: AppColors.primary,
            onRefresh: () async {
              context
                  .read<PermitLetterProgressBloc>()
  ...
  Widget _buildBody(PermitLetterProgressState state) {
