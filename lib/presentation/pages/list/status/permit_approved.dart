...
class PermitApproved extends StatefulWidget {
  ...
  @override
  State<PermitApproved> createState() => _PermitApprovedState();
}

class _PermitApprovedState extends State<PermitApproved> {
  String? _authToken;
  ...
  Widget build(BuildContext context) {
    return BlocListener<PermitLetterApprovedBloc, PermitLetterApprovedState>(
  ...
  Widget _buildBody(PermitLetterApprovedState state) {
